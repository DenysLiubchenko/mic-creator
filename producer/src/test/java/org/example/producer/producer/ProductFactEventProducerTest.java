...
public class ProductFactEventProducerTest {
    ...
    void sendCreateEventTest() {
        ...
        given(kafkaAvroSerializer.serialize(PRODUCT_TOPIC, productFactEvent)).willReturn(serializedEvent);
        ...
        then(kafkaAvroSerializer).should().serialize(PRODUCT_TOPIC, productFactEvent);
